            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="mb-12" data-aos="fade-right" data-aos-delay="200">
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">Yang Termasuk</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="flex items-center space-x-3">
                                <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-gray-700">Jeep + Driver berpengalaman</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-gray-700">Bahan bakar</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-gray-700">Tiket masuk wisata</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-gray-700">Pemandu lokal</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                </svg>
                                <span class="text-gray-700">Dokumentasi perjalanan</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                    ...
                    <div class="mb-12" data-aos="fade-right" data-aos-delay="400">
                        <h3 class="text-2xl font-bold text-gray-900 mb-6">Itinerary</h3>
                        <div class="space-y-6">
                            <div class="flex space-x-4">
                                ...
                                <div>
                                    <h4 class="text-lg font-semibold text-gray-900 mb-2">Penjemputan & Briefing</h4>
                                    <p class="text-gray-600">Penjemputan di meeting point dan briefing keselamatan sebelum memulai perjalanan.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex space-x-4">
                                ...
                                <div>
                                    <h4 class="text-lg font-semibold text-gray-900 mb-2">Perjalanan Menuju Lokasi</h4>
                                    <p class="text-gray-600">Perjalanan dengan jeep melintasi jalur off-road menuju destinasi utama.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex space-x-4">
                                ...
                                <div>
                                    <h4 class="text-lg font-semibold text-gray-900 mb-2">Eksplorasi & Foto</h4>
                                    <p class="text-gray-600">Eksplorasi lokasi wisata dengan sesi foto dan penjelasan dari pemandu lokal.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex space-x-4">
                                ...
                                <div>
                                    <h4 class="text-lg font-semibold text-gray-900 mb-2">Kembali ke Base Camp</h4>
                                    <p class="text-gray-600">Perjalanan kembali ke base camp dengan kenangan yang tak terlupakan.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-6">
                        ...
                        <div class="bg-white rounded-lg shadow-lg p-6 mb-8" data-aos="fade-left">
                            ...
                            <!-- Booking Buttons -->
                            <div class="space-y-3">
                                <a href="https://wa.me/6281234567890?text=Halo,%20saya%20ingin%20booking%20paket%20{{ urlencode($package->name) }}%20untuk%20tanggal%20..."
                                   target="_blank"
                                   class="w-full bg-green-600 hover:bg-green-700 text-white text-center px-6 py-3 rounded-lg font-bold transition-colors flex items-center justify-center">
                                ...
                                <a href="{{ route('contact') }}"
                                   class="w-full bg-gray-100 hover:bg-gray-200 text-gray-800 text-center px-6 py-3 rounded-lg font-medium transition-colors">
