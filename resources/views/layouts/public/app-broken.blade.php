<!DOCTYPE h    <!-    <m    <!-- Open Graph / Facebook -->
    ...
    <meta property="twitter:image" content="@yield('og_image', asset('images/default-og.jpg'))""og:title" content="@yield('og_title', @yield('title', 'Jeep Merapi Adventure'))">
    ...
    <meta property="twitter:image" content="@yield('twitter_image', @yield('og_image'))")ph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="@yield('og_title', @yield('title', 'Jeep Merapi Adventure'))">
    <meta property="og:description" content="@yield('og_description', @yield('description'))">
    <meta property="og:image" content="@yield('og_image', asset('images/default-og.jpg'))">html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
    ...
    <meta property="twitter:title" content="@yield('twitter_title', '@yield('title')')">
    <meta property="twitter:description" content="@yield('twitter_description', '@yield('description')')">
    <meta property="twitter:image" content="@yield('twitter_image', '@yield('og_image')')">
